...
export default function Lookbook() {
  ...
  const getGridClasses = (index) => {
    switch (index) {
      case 0: return "md:col-span-7 md:row-span-2 aspect-[4/5] md:aspect-auto"; // Large feature portrait
      case 1: return "md:col-span-5 md:row-span-1 aspect-square md:aspect-auto"; // Square top right
      case 2: return "md:col-span-5 md:row-span-1 aspect-[4/3] md:aspect-auto"; // Landscape bottom right
      case 3: return "md:col-span-4 md:row-span-2 aspect-[3/4] md:aspect-auto"; // Tall editorial
      case 4: return "md:col-span-4 md:row-span-1 aspect-square md:aspect-auto"; // Small square center
      case 5: return "md:col-span-4 md:row-span-1 aspect-square md:aspect-auto"; // Small square right
      case 6: return "md:col-span-8 md:row-span-2 aspect-[16/9] md:aspect-auto"; // Large landscape span
      case 7: return "md:col-span-4 md:row-span-2 aspect-[3/4] md:aspect-auto"; // Tall editorial span
  ...
  return (
    <section id="lookbook" className="py-16 lg:py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 auto-rows-[auto] md:auto-rows-[300px]">
          {gallery.map((item, i) => (
            <div key={item.id} className={`relative group overflow-hidden border border-cream/5 ${getGridClasses(i)}`}>
              <ImageReveal type="clip" delay={i * 0.1} className="w-full h-full">
                <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="relative w-full h-full block overflow-hidden bg-secondary">
                  <motion.div 
                  ...
                  >
                    <PremiumImage 
                      ...
                      hover={false} // Disable internal PremiumImage hover to let group handle it
                    />
                  </motion.div>
                  
                  {/* Subtle Dark Overlay */}
                  <div className="absolute inset-0 bg-primary/20 group-hover:bg-primary/50 transition-colors duration-500 z-10"></div>
